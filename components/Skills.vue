<template>
  <div class="pt-6 text-center">
    <p class="font-sans font-bold text-4xl text-pink-600">What can I do?</p>
    <p class="font-sans text-lg">Learning new languages and frameworks is what keeps me going. Here are a list of my current skills:</p>
    <div class="pt-6 flex flex-wrap justify-center">
      <div class="flex justify-start items-center pb-6 pr-10">
        <svg class="fill-current text-gray-800 hover:text-pink-600 inline-block h-12 w-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
        ...
        <app-progress-bar class="pl-6" progress-inner-width="30" />
      </div>
      <div class="flex justify-start items-center pb-6 pr-10">
        <svg class="fill-current text-gray-800 hover:text-pink-600 inline-block h-12 w-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
        ...
        <app-progress-bar class="pl-6" progress-inner-width="10" />
      </div>
      <div class="flex justify-start items-center pb-6 pr-10">
        <svg class="fill-current text-gray-800 hover:text-pink-600 inline-block h-12 w-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
        ...
        <app-progress-bar class="pl-6" progress-inner-width="100" />
      </div>
      <div class="flex justify-start items-center pb-6 pr-10">
        <svg class="fill-current text-gray-800 hover:text-pink-600 inline-block h-12 w-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        ...
        <app-progress-bar class="pl-6" progress-inner-width="99" />
      </div>
    </div>
  </div>
</template>
